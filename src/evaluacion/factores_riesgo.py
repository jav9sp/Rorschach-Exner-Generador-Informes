...
def evaluar_factores(variables, estados_simple):
    ...
    l = estados_simple.get("Lambda", "Indefinido")
    eb = variables.get("Tipo Vivencial", 0)

    # Factor 1 - Ideacional con EB Intro + Lambda↓
    if eb == "Introversivo" and (l == "bajo" or l == "muy bajo"):
    ...
    if eb == "Extroversivo" and (l == "bajo" or l == "muy bajo"):
    ...
    if eb == "Ambigual" and (l == "bajo" or l == "muy bajo"):
        resultados.append(
    ...
    if eb == "Introversivo" and (l == "alto" or l == "muy alto"):
        resultados.append(
    ...
    if eb == "Extroversivo" and (l == "alto" or l == "muy alto"):
    ...
    if eb == "Ambigual" and (l == "alto" or l == "muy alto"):
        resultados.append(
    ...
    s = estados_simple.get("S", "Indefinido")
